// github.com/ankitmalik84
// twitter.com/AnkitMalik84
// instagram.com/ch.ankit.malik
  ...
  switch (targetTheme) {
    ...
    case "theme2":
      ...
      blurElement.style.background =
        "linear-gradient(29deg, rgba(0,255,252,1) 0%, rgba(9,53,121,1) 61%)";
    ...
    case "theme3":
      ...
      musicBox.style.border = "1px solid #ffffff12";
      blurElement.style.background =
        "linear-gradient(29deg, rgba(227,0,0,1) 22%, rgba(209,120,195,1) 50%, rgba(0,82,255,1) 79%)";
      coverImage.style.background = "#288bcf75";
      trackProgressBar.style.background = "#0fd5ca73";
      currentTrackTimeBar.style.background = "#ba0f0f";
      trackLoading.style.background = "#0fd5ca";
      break;

    case "theme4":
      blurElement.style.visibility = "visible";
      musicBox.style.border = "1px solid white";
      blurElement.style.background =
        "linear-gradient(29deg, rgba(240,245,246,0.2) 0%, rgba(199,238,247,0.2) 78%)";
      coverImage.style.background = "#288bcf75";
      trackProgressBar.style.background = "#505f62";
      currentTrackTimeBar.style.background = "white";
      trackLoading.style.background = "white";
      break;
  }
});
